...
#ccall_unsafe 	wasmtime_config_memory_may_move_set ,                 Ptr <wasm_config_t> -> Bool -> IO ()
#ccall_unsafe 	wasmtime_config_memory_reservation_set ,              Ptr <wasm_config_t> -> Word64 -> IO ()
#ccall_unsafe 	wasmtime_config_memory_guard_size_set ,               Ptr <wasm_config_t> -> Word64 -> IO ()
