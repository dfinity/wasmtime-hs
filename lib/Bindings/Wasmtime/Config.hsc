...
-- #ccall 	wasmtime_config_strategy_set (wasm_config_t *, wasmtime_strategy_t)
...
-- #ccall 	wasmtime_config_cranelift_opt_level_set (wasm_config_t *, wasmtime_opt_level_t)
-- #ccall 	wasmtime_config_profiler_set (wasm_config_t *, wasmtime_profiling_strategy_t)
#ccall 	wasmtime_config_static_memory_forced_set , Ptr <wasm_config_t> -> Bool -> IO ()
-- #ccall 	wasmtime_config_static_memory_maximum_size_set (wasm_config_t *, uint64_t)
-- #ccall 	wasmtime_config_static_memory_guard_size_set (wasm_config_t *, uint64_t)
-- #ccall 	wasmtime_config_dynamic_memory_guard_size_set (wasm_config_t *, uint64_t)
