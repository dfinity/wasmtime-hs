...
#ccall_unsafe wasmtime_module_new , \
  Ptr <wasm_engine_t> -> \
  Ptr Word8 -> \
  CSize -> \
...
#ccall_unsafe wasmtime_module_deserialize_file , \
  Ptr <wasm_engine_t> -> \
  Ptr CChar -> \
  Ptr (Ptr <wasmtime_module_t>) -> \
  IO (Ptr <wasmtime_error_t>)
